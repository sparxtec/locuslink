CREATE TABLE "product_test_type" (
  "product_test_type_pkid" int PRIMARY KEY,
  "type_code" varchar,
  "type_desc" varchar,
  "add_by" varchar,
  "add_ts" timestamp,
...
CREATE TABLE "product_test" (
  "product_test_pkid" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
ALTER TABLE "product_template" ADD CONSTRAINT "fk_ptemplate_pt" FOREIGN KEY ("product_type_pkid") REFERENCES "product_type" ("product_type_pkid");

ALTER TABLE "product_test" ADD CONSTRAINT "fk_ptt_pt" FOREIGN KEY ("product_test_type_pkid") REFERENCES "product_test_type" ("product_test_type_pkid");
...
ALTER TABLE "unique_asset" ADD CONSTRAINT "fk_ua_mfg" FOREIGN KEY ("manufacturer_pkid") REFERENCES "manufacturer" ("manufacturer_pkid");
...
ALTER TABLE "purchase_order" ADD CONSTRAINT "fk_project_po" FOREIGN KEY ("project_pkid") REFERENCES "project" ("project_pkid");
