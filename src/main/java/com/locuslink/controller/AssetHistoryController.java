...
public class AssetHistoryController {
	...
	@PostMapping(value = "/initAssetHistory")
	public String initAssetHistory (@ModelAttribute(name = "uniqueAssetDTO") UniqueAssetDTO uniqueAssetDTO,	Model model, HttpSession session) {
		
		logger.debug("Starting initAssetHistory()...");
		...
		if (uniqueAssetDTO == null) {
	   	...
	   	return "fragments/asset-history";
	}
